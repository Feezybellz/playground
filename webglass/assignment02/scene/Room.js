...
export class Room extends SceneObject {
  ...
  // setFurnitureGroupPosition(position) {
  //   this.furnitureGroup.position = position;
  //   this.furnitureGroup.updateModelMatrix();
  // }

  // moveFurniture(position) {
  //   this.furnitureGroup.position = position; // Update group's position
  //   this.furnitureGroup.updateModelMatrix(); // Update group's and children's matrices
  // }
